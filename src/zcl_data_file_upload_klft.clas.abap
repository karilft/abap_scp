CLASS zcl_data_file_upload_klft DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
...
* Unpack input field values such as tablename, dataoption, etc.
        ...
        IF ui_dataref IS BOUND.
          ...
          tablename = me->get_input_field_value( name = 'TABLENAME' dataref =
          <ui_dataref> ).
          dataoption = me->get_input_field_value( name = 'DATAOPTION' dataref
          = <ui_dataref> ).
        ENDIF.
